...
python send_slack.py "Test ended and results uploaded at https://github.com/benlycos/automation-results/blob/main/${DTE}/${SRL_NO}/${FLD}.tar.gz for ${SRL_NO} at $(date)" "${SLACK_URL}"
