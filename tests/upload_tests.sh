...
python send_slack.py "Test ended and results uploaded. Report available at https://benlycos.github.io/automation-results/report/home?file-path=${DTE}/${SRL_NO}/${FLD}.tar.gz for ${SRL_NO} at $(date)" "${SLACK_URL}"
